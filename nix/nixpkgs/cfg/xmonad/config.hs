...
myFont :: String
myFont = "xft:Iosevka Nerd Font Mono:bold:size=11:antialias=true:hinting=true"
...
myWorkspaces = clickable . (map xmobarEscape)
               -- $ [" ΌΡΟΣ ", " ΜΟΥΣΙΚΉ ", " ΔΙΑΔΊΚΤΥΟ ", " ΑΡΧΕΊΟ ", " Ντεβ "]
...
myKeys =
    -- Xmonad
        ...
        , ("M-S-q", spawn "scrot")                  -- Quits xmonad
    ...
    -- Floating windows
        , ("M-p", sendMessage (T.Toggle "floats"))       -- Toggles my 'floats' layout
    ...
    -- Multimedia Keys
        ...
        -- Appending search engine prompts to kMovieMovieeybindings list.
...
main = do
    ...
    xmproc0 <- spawnPipe "xmobar -x 0 /home/shiva/.config/xmobar/xmobarrc0"
    ...
    xmonad $ ewmh def
        ...
        , logHook = workspaceHistoryHook <+> myLogHook <+> dynamicLogWithPP xmobarPP
                        ...
                        , ppHidden = xmobarColor "#83baeb" "" . wrap "" ""   -- Hidden workspaces in xmobar
